...
@WebServlet(name = "SortServlet", urlPatterns = "/api/sortedMovies")
public class SortServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // SORTING STUFF
        String sortBy = request.getParameter("sortFirst");
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            if(!movieTitle.isEmpty()) {
                query = query + " AND m.title LIKE '%" + movieTitle + "%'";
            }
            ...
            if (!sortBy.isEmpty()) {
                if (sortBy.equals("title")) {
                    query += " ORDER BY title " + titleSort + ", rating " + ratingSort;
                    request.getServletContext().log("sorting by title, query: " + query);
                } else if (sortBy.equals("rating")) {
                    query += " ORDER BY rating " + ratingSort + ", title " + titleSort;
                    request.getServletContext().log("sorting by rating, query: " + query);
                }
            }
